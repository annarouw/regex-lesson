...
date: "2022-01-11 and last compiled `r Sys.time`"
...
str_extract(match_character_example, "[[:space:]]+") ## any white space
...
str_extract(match_character_example, "[[:alnum:]]+") ## Does not capture spaces
...
negative_look_behind_example <- c("AL, USA", "CA, USA", "FL, USA", "BC, CAN", "ON, CAN")
...
# extract values preceeded dollar sign (which must be escaped)  
str_extract( wn ,"\\$\\d+") 
